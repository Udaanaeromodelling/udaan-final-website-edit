...
const Page = () => {
    ...
    return (
        <div className="about-page min-h-screen bg-gray-100 py-8 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Video Section */}
                    <div className="w-full h-[40vh] sm:h-[50vh] md:h-[60vh] lg:h-[80vh] rounded-lg overflow-hidden shadow-lg flex items-center justify-center bg-black">
                        <video
