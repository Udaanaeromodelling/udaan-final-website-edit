  ...
  return (
    <div className='about-page'>
            <header className='height-75'>
                <div className='container h-100 d-flex flex-column align-items-center justify-content-center text-light'>
                    <h1 className='text-center fw-semibold italic text-purple-300 upercase '>Page</h1>
    ...
    <div className="w-full mb-8">
        <video className="w-full h-auto rounded-lg shadow-lg" controls>
            <source src="https://drive.google.com/file/d/1-nZWN_atxmvqdK5U0e1ckV-sBhh2QJPJ/view?usp=sharing" type="video/mp4" />
    ...
    <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-1/2 bg-white p-6 rounded-lg shadow-md flex items-center justify-center">
            <a href="https://unstop.com/competitions/flight-quest-udaan-aeromodellng-club-1308524?lb=dSkZmec" 
