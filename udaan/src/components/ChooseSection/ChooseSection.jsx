  ...
  return (
    <div>
      <div className="container">
        <h2 className='text-center mb-5 font-bold text-black'>We Are</h2>
        <div className='row g-4'>
          <div className='col-lg-4'>
            <Card className='d-flex align-items-center border-0 h-100 hover:scale-105 hover:shadow-xl hover:shadow-blue-400 transition-all duration-300'>
              <div className='mt-3'>
              ...
              <Card.Body>
                <Card.Title className='text-center text-capitalize mb-3 italic'>
                  8+ Times Winner
                </Card.Title>
                <Card.Text className='text-justify italic'>
          ...
          <div className='col-lg-4'>
            <Card className='d-flex align-items-center border-0 h-100 hover:scale-105 hover:shadow-xl hover:shadow-blue-400 transition-all duration-300'>
              ...
              <Card.Body>
                ...
                <Card.Text className='italic text-justify'>
